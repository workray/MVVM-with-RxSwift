...
-(NSInteger)write:(const uint8_t *)buffer maxLength:(NSUInteger)maxLength completionHandler:(void(^)(void))completionHandler
{
...
-(BOOL) uploadBufferWithCompletionHandler:(void(^)(void))completionHandler
{
...
-(BOOL)closeWithCompletionHandler:(void (^)(void))completionHandler
{
